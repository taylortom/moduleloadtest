...
class LoggerModule extends AbstractModule {
  ...
  */
  async initialise() {
    ...
    console.log(this.getConfig('test'));
    const enabledLevels = this.app.config.get('adapt-authoring-logger.enabledLevels');
    const isLevelEnabled = key => this.app.config && enabledLevels.includes(level);
    /**
    * @type {Object}
    */
    this.config = {
      ...
      timestamp: this.app.config && this.app.config.get('adapt-authoring-logger.showTimestamp')
    };
    this.setReady();
  }
  /**
